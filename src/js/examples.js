 ...
 *           </p>
 *           <div><span class="handle-1 horizontal">Horizontal: </span><span class="value"></span></div>
 *           <div><span class="handle-1 vertical">Vertical: </span><span class="value"></span></div>
 *       </div>
 *       <div id="slider-2D-1">
 ...
 * 
 * const E1GP1 = new S2D({
 *     point: document.querySelector('.example1 .grapple-point-11'),
 *     moveTo: {
 *         x: 50,
 *         y: 50
 *     }
 * });
 * 
const E1GP1Horizontal = document.querySelector('.example-1 .handle-1.horizontal + .value');
 *
const E1GP1Vertical = document.querySelector('.example-1 .handle-1.vertical + .value');
 ...
 * });
 * 
 * const E2GP1Horizontal = document.querySelector('.handle-1.horizontal + .value');
 * 
...
const E2GP1Horizontal = document.querySelector('.example-2 .handle-1.horizontal + .value');
E2GP1.setOnMoveFunction(function() {
    const values = E2GP1.getValues();
    E2GP1Horizontal.innerHTML = values.h+values.hSuffix;
}, true);
 ...
 * });
 * 
 * const E3GP1Vertical = document.querySelector('example-3 .handle-1.vertical + .value');
 * 
 ...
 *           <div><span class="handle-1 vertical">Vertical: </span><span class="value"></span></div>
 * 
 *           <div><span class="handle-2 horizontal">Horizontal: </span><span class="value"></span></div>
 *           <div><span class="handle-2 vertical">Vertical: </span><span class="value"></span></div>
 *       </div>
 *       <div id="slider-2D-4">
 ...
 * });
 * 
 * const E4GP1Horizontal = document.querySelector('.example-4 .handle-1.horizontal + .value');
 * const E4GP1Vertical = document.querySelector('.example-4 .handle-1.vertical + .value');
 * 
 * const E4GP2Horizontal = document.querySelector('.example-4 .handle-2.horizontal + .value');
 * const E4GP2Vertical = document.querySelector('.example-4 .handle-2.vertical + .value');
 * 
